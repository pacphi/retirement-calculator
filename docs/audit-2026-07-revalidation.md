...
| 4   | D — free survivor annuity          | apply DRS option factor when `pensionPct > 0` — **implemented** (full 2026 TRS 2/3 factor table, pop-up restoration, RCW 41.32.895 pre-retirement survivor annuity) | S                 | no (default elects 0%)          |
