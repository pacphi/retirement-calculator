...
export const LOCATIONS = [
  ...
  // Tier 1 locations (Wave 5, autopilot pension-location-data phase 4). Source:
  // docs/research/location-cost-of-living-data.md §1-3. dataAsOf stamps the cost-basket
  // vintage per the widening-appeal proposal's §4 versioning recommendation -- ltcAnnual for
  // all three is a low-confidence PLACEHOLDER (phase 1's research did not source an LTC figure
  // for Latin America, unlike the Europe/US entries above), scaled down from the closest-tier
  // European entries as a planning-grade estimate pending a dedicated LTC-cost refresh.
  { name:"Mexico", region:"Latin America", dataAsOf:2026, ltcAnnual:18000, addlTaxRate:0.03, hcPre:400, hcPost:100, m:{rent:900,groceries:450,utilities:120,transport:120,dining:280,entertainment:160,misc:220}, vat:"16% IVA", incomeTax:"Worldwide for tax residents; treaty leaves IRA/401(k) enforcement ambiguous", note:"Figures are Lake Chapala/Ajijic-style, the largest US retiree colony; Mexico City runs pricier. Residente Temporal visa needs roughly $1,500-4,400/mo (wide consulate variance) or about $74,000 in savings." },
  { name:"Panama", region:"Latin America", dataAsOf:2026, ltcAnnual:16000, addlTaxRate:0, hcPre:150, hcPost:120, m:{rent:1100,groceries:450,utilities:130,transport:140,dining:300,entertainment:180,misc:250}, vat:"7% ITBMS (10% alcohol/hotels, 15% tobacco)", incomeTax:"Territorial -- foreign-source income 100% exempt", note:"Figures are Panama City-style; Boquete's mountain towns run cheaper. Pensionado visa needs a guaranteed $1,000/mo pension ($1,250 couple), reduced to $750/mo with $100k+ in Panama real estate." },
  { name:"Costa Rica", region:"Latin America", dataAsOf:2026, ltcAnnual:15000, addlTaxRate:0, hcPre:200, hcPost:90, m:{rent:900,groceries:420,utilities:130,transport:130,dining:280,entertainment:160,misc:230}, vat:"13% IVA (reduced 1-4% for health/education/basics)", incomeTax:"Territorial -- foreign-source income fully exempt", note:"Figures are San Jose/Central Valley-style; Tamarindo beach towns run pricier on housing. Pensionado visa needs a guaranteed $1,000/mo pension (one stream covers a couple) -- the threshold is under active discussion for a raise." },
  // Tier 2 locations (Wave 5, autopilot pension-location-data phase 5). Source:
  // docs/research/location-cost-of-living-data.md §4-9. Thailand/Vietnam's addlTaxRate carries
  // the same "planning-grade estimate, verify with a cross-border specialist" caveat the
  // Austria/Netherlands entries above already use, per the phase-5 convention -- remittance-basis
  // rules (Thailand's Por.161/2566, Vietnam's no-treaty worldwide taxation) are genuinely
  // fact-specific to how/when money is moved, not a single clean rate. Australia carries an
  // explicit product-honesty flag in its note: no general retirement visa is open to new
  // applicants (docs/research/location-cost-of-living-data.md's cross-cutting flag #1).
  { name:"Thailand", region:"Southeast Asia", dataAsOf:2026, ltcAnnual:15000, addlTaxRate:0.03, hcPre:350, hcPost:300, m:{rent:650,groceries:320,utilities:120,transport:80,dining:280,entertainment:130,misc:200}, vat:"7%", incomeTax:"Remittance-basis worldwide since 2024 (Por.161/2566); US Social Security is treaty-exempt, other remitted pension income is assessable -- planning-grade estimate, verify with a cross-border tax specialist", note:"Figures are Chiang Mai-style; Bangkok runs pricier. Non-Immigrant O-A visa (50+) needs a ~$24,000 Thai bank deposit or ~$1,950/mo income, plus mandatory health insurance." },
  { name:"Vietnam", region:"Southeast Asia", dataAsOf:2026, ltcAnnual:9000, addlTaxRate:0.065, hcPre:350, hcPost:300, m:{rent:650,groceries:300,utilities:100,transport:40,dining:260,entertainment:120,misc:190}, vat:"8% (temporarily reduced, extended through 2026)", incomeTax:"Worldwide, progressive 5-35%; NO US-Vietnam tax treaty, so relief relies solely on the US Foreign Tax Credit -- planning-grade estimate, verify with a cross-border tax specialist (the highest tax uncertainty of the Southeast Asia locations here)", note:"Figures are Da Nang/Hoi An-style (Numbeo self-flags this basket as possibly stale/understated); Ho Chi Minh City runs pricier. No dedicated retirement visa exists -- retirees use the Investor (DT) visa (~$125,000 min investment), 90-day e-visas with border runs, or family sponsorship." },
  { name:"Malaysia", region:"Southeast Asia", dataAsOf:2026, ltcAnnual:15000, addlTaxRate:0.005, hcPre:350, hcPost:300, m:{rent:600,groceries:340,utilities:90,transport:50,dining:280,entertainment:150,misc:210}, vat:"No VAT -- SST 5-10% sales / 6-8% service", incomeTax:"Foreign-sourced income remitted by individuals is exempt through end-2036 under current policy -- effectively territorial for this window", note:"Figures are Penang-style; Kuala Lumpur runs pricier. MM2H Silver visa needs a ~$150,000 fixed deposit plus RM600,000 in property (Gold/Platinum tiers scale higher); figures are secondary-sourced, not portal-verified." },
  { name:"Philippines", region:"Southeast Asia", dataAsOf:2026, ltcAnnual:10000, addlTaxRate:0, hcPre:300, hcPost:280, m:{rent:750,groceries:360,utilities:150,transport:50,dining:320,entertainment:170,misc:230}, vat:"12%", incomeTax:"Territorial -- foreign pensions, US Social Security, and IRA withdrawals are not taxed", note:"Figures are Manila-style; Cebu runs similar and is a popular alternative. SRRV Classic visa (50+) needs a $15,000 time deposit plus proof of at least $800/mo pension income." },
  { name:"Australia", region:"Oceania", dataAsOf:2026, ltcAnnual:50000, addlTaxRate:0.10, hcPre:420, hcPost:380, m:{rent:2900,groceries:650,utilities:215,transport:250,dining:280,entertainment:150,misc:250}, vat:"10% GST", incomeTax:"Worldwide; top marginal ~45% + 2% Medicare levy (US Social Security is a treaty exception, generally not taxed)", note:"PRODUCT-HONESTY FLAG: Australia has no general retirement visa open to new applicants -- the Investor Retirement visa (405) is closed and subclass 410 only covers narrow legacy cases. Realistic pathways for a US retiree are family-based only (a 15-33 year wait) or a partner/skilled route. Treat this as a cost-of-living reference, not a retirable-to destination, absent a family or skilled-immigration pathway. Figures are Sydney-style; Brisbane runs cheaper. The US is not on Australia's Reciprocal Health Care Agreement, so a retiree needs private cover at any age." },
  { name:"Uruguay", region:"Latin America", dataAsOf:2026, ltcAnnual:20000, addlTaxRate:0.05, hcPre:400, hcPost:400, m:{rent:900,groceries:500,utilities:200,transport:100,dining:200,entertainment:120,misc:180}, vat:"22% IVA (10% reduced on basics)", incomeTax:"New tax residents (from Jan 1, 2026) may elect a ~10-year exemption on foreign-source income (\"Tax Holiday 2.0\") or a flat 7% on foreign passive income indefinitely; foreign employment income is untaxed", note:"Figures are Montevideo-style (Numbeo's own commenters flag rents as understated; nudged above the raw figure). ltcAnnual is a low-confidence PLACEHOLDER -- no authoritative published nursing-home figure was found for Uruguay. Independent Means retiree visa needs about $2,500/mo couple income, notary-certified, leading directly to permanent residency." },
  // Tier 3/4 locations (Wave 5, autopilot pension-location-data phase 6 -- completes the
  // proposal's location roadmap). Source: docs/research/location-cost-of-living-data.md §10-13.
  // New Zealand and Japan both carry explicit product-honesty flags in their notes: New Zealand's
  // "retiree visa" is a high-barrier investor product with no path to permanent residency, and
  // Japan has NO dedicated retirement visa at all -- the strongest such flag in the research brief.
  { name:"South Africa", region:"Africa", dataAsOf:2026, ltcAnnual:13500, addlTaxRate:0.06, hcPre:350, hcPost:300, m:{rent:950,groceries:450,utilities:118,transport:90,dining:250,entertainment:150,misc:200}, vat:"15%", incomeTax:"Worldwide, no territorial exemption; no US-SA totalization agreement; SA removed its foreign-pension exemption in 2025 -- planning-grade estimate, verify with a cross-border tax specialist", note:"Figures are Cape Town-style. Retired Person's Visa needs a guaranteed ~$2,250/mo pension/annuity income -- a 2026 Cabinet-approved White Paper proposes raising this threshold, which has been static for 15 years and is at risk of change." },
  { name:"Colombia", region:"Latin America", dataAsOf:2026, ltcAnnual:12000, addlTaxRate:0.01, hcPre:250, hcPost:200, m:{rent:800,groceries:400,utilities:104,transport:120,dining:250,entertainment:130,misc:180}, vat:"19% IVA", incomeTax:"Worldwide, but Law 2381 of 2024 exempts foreign pensions up to about $14,000/mo -- Social Security and government/corporate pensions are effectively exempt for most retirees; IRA/401(k) withdrawals are less certain and may be taxed as ordinary income", note:"Figures are Medellin-style (COP moved ~15% in 2 months during this research -- treat as exchange-rate sensitive); Bogota runs cheaper on rent. Pensionado (M-11) visa needs a lifetime pension of about $1,380-1,410/mo; figures are secondary-sourced, not portal-verified (the official Cancilleria page blocks automated access)." },
  { name:"New Zealand", region:"Oceania", dataAsOf:2026, ltcAnnual:45000, addlTaxRate:0.08, hcPre:325, hcPost:325, m:{rent:1600,groceries:620,utilities:178,transport:200,dining:230,entertainment:150,misc:220}, vat:"15% GST", incomeTax:"Worldwide after a 4-year transitional exemption for new migrants; foreign pension income is then generally taxable under the US-NZ treaty (top resident rate ~39%)", note:"PRODUCT-HONESTY FLAG: the Temporary Retirement Visitor Visa is a high-barrier investor product (NZ$750,000 to invest + NZ$500,000 maintenance funds + NZ$60,000 annual income), not an easy retiree pathway, and has NO direct path to permanent residency. Treat this as a cost-of-living reference for well-funded retirees only, not a realistic passive-income destination. Figures are Auckland-style." },
  { name:"Japan", region:"East Asia", dataAsOf:2026, ltcAnnual:25000, addlTaxRate:0.08, hcPre:300, hcPost:250, m:{rent:1300,groceries:600,utilities:155,transport:150,dining:300,entertainment:200,misc:250}, vat:"10%", incomeTax:"Worldwide for residents; Japan does NOT recognize US tax-deferred IRA/401(k) status, so distributions are taxed as ordinary income -- non-permanent residents (first 5 of the last 10 years) are taxed only on Japan-source income plus foreign income actually remitted into Japan, a real early-years planning lever", note:"PRODUCT-HONESTY FLAG (the strongest in this dataset): Japan has NO dedicated retirement visa, and immigration authorities have consistently declined to create one. The closest option (Long Stay, Designated Activities No. 40) caps out at 12 months total and does not lead to permanent residency. Treat Japan as a max-1-year stay or a cost-of-living reference, not a realistic long-term retirement destination. Figures are Tokyo-style; Osaka runs markedly cheaper." },
];
