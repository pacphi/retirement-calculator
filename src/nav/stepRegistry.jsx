...
export function buildSteps(ctx) {
  ...
  return [
    ...
    { id: "place", num: 5, title: "Retiring to", render: () => <RetirementPlace s={s} set={set} /> },
    { id: "inheritance", num: 6, title: "Real Estate", render: () => <InheritanceStep s={s} addProperty={ctx.addProperty} removeProperty={ctx.removeProperty} setProperty={ctx.setProperty} /> },
